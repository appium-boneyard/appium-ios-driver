...
describe('safari - webview - special capabilities @skip-ios6', () => {
  ...
  beforeEach(() => await loadWebView(specialCaps, driver););
  ...
  // by the pref on iOS8
  it('should not display a phishing warning with safariIgnoreFraudWarning @skip-chrome @skip-ios8', () => {
    let titleToBecomeRight = new ChaiAsserter((driver) =>
...
describe('performance logs @skip-real-device', () => {
  let specialCaps = Object.assign({}, desired);
  ...
  it('should fetch performance logs', () => {
