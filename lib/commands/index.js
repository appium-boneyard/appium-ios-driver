...
import scrollCommands from './scroll';
...
for (let obj of [
  ...
  screenshotCommands, scrollCommands, deviceCommands, safariCommands, coverageCommands, timeoutCommands
]) {
