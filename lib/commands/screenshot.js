...
commands.getViewportScreenshot = async function () {
  ...
  // There is no way to grab scale from UIAutomation. Almost all devices have scale 2.0 except iPhone 6+, iPhone 6s+, iPhone7+ - 3.0.
  const screenHeightOfPlusDevices = 736;
  const scale = screenHeight === screenHeightOfPlusDevices ? 3 : 2;
