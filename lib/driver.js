...
class IosDriver extends BaseDriver {
 ...
 async startSession (caps) {
  ...
  async startSimulator (caps) {
    ...
    {
      // setDeviceInfo()
      this.shouldPrelaunchSimulator = utils.shouldPrelaunchSimulator(caps, this.iOSSDKVersion);
      let dString = utils.getDeviceString(this.xcodeVersion, this.iosSdkVersion, caps);
      await utils.setDeviceTypeInInfoPlist(caps.app, dString);
    }

    await this._checkPreferences(caps);
