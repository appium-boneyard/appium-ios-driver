...
function prepareIosOpts (opts) {
  ...
  opts.robotUrl = opts.useRobot ?
    "http://" + opts.robotAddress + ":" + opts.robotPort + "" :
    null;
  ...
  if (parseFloat(opts.platformVersion) < 7.1) {
    logger.warn('iOS version', opts.platformVersion,
                                'iOS ' + opts.platformVersion + ' support has ' +
...
export default { rootDir, removeInstrumentsSocket, getAndCheckXcodeVersion, prepareIosOpts,
  appIsPackageOrBundle, getAndCheckIosSdkVersion, moveBuiltInApp,
