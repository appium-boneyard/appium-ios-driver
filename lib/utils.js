...
// TODO: this should be moved to appium-ios-simulator, separated by xcode
function getDeviceString (xcodeVersion, iosSdkVersion, caps) {
  ...
  switch (xcodeVersion[0]) {
    ...
    case '6':
      // pass through
    case '7':
      iosDeviceString = caps.deviceName || (isiPhone ? 'iPhone Simulator' : 'iPad Simulator');
      break;
  }
  ...
  let configFix = xcodeVersion[0] === 7 ? CONFIG_FIX__XCODE_7 : CONFIG_FIX;
...
export default { rootDir, removeInstrumentsSocket, getAndCheckXcodeVersion, prepareIosOpts,
  ...
  endAllSimulatorDaemons, getSimForDeviceString, unwrapEl };
