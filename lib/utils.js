...
async function getAndCheckXcodeVersion (caps) {
  ...
  if (minorVersion < 6.3 && (!(minorVersion === 6.0 && pv === 8.0))) {
    logger.warn( `Xcode version '${versionNumber}'. Support for Xcode ` +
                 `${versionNumber} has been deprecated and will be removed ` +
...
export default { rootDir, removeInstrumentsSocket, getAndCheckXcodeVersion, prepareIosOpts,
  ...
  setBundleIdFromApp, shouldPrelaunchSimulator, setDeviceTypeInInfoPlist, getSimForDeviceString,
  unwrapEl };
